    ...
    >
      ...
      >
        ...
        >
          ...
          <Dialog open={Boolean(osc7SetupOpen)} onOpenChange={setOsc7SetupOpen}>
            <DialogContent className="sm:max-w-[640px]">
              ...
              <DialogFooter>
                <Button variant="secondary" onClick={() => setOsc7SetupOpen(false)}>
                  {t("common.cancel")}
                </Button>
                <Button onClick={handleOsc7SetupConfirm}>
