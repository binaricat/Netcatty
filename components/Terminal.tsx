...
const TerminalComponent: React.FC<TerminalProps> = ({
  ...
  xTermRuntimeContextRef.current = {
    ...
    hasRememberedEncodingRef: hasRememberedTerminalEncodingRef,
    serialLineBufferRef,
