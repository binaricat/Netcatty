...
`,
  ...
  'settings.terminal.keyboard.kittyProtocol': 'Протокол клавиатуры Kitty (экспериментально)',
  'settings.terminal.keyboard.kittyProtocol.desc':
    'Включить неполную поддержку протокола клавиатуры Kitty для новых сеансов. Некоторые TUI-приложения могут перестать принимать ввод.',
