...
`,
  ...
  'vault.groups.deleteDialog.mixedDesc': 'Эта группа содержит хосты, импортированные из связанного SSH-конфига. Эти хосты будут удалены; остальные хосты будут перемещены в корень, если вы также не удалите их ниже.',
