...
export const ruAiMessages: Messages = {
  ...
  'ai.antigravity.description': 'Использует официальную команду agy и существующий вход Google. Netcatty обнаруживает её автоматически, но не загружает и не включает в приложение.',
  'ai.antigravity.detecting': 'Обнаружение...',
  'ai.antigravity.detected': 'Обнаружен',
  'ai.antigravity.upgradeStatus': 'Требуется обновление',
  'ai.antigravity.notFound': 'Не найден',
  'ai.antigravity.path': 'agy:',
  'ai.antigravity.notFoundHint': 'Не удалось найти agy версии 1.1.4 или новее в PATH. Установите её с сайта Google или укажите путь ниже.',
  'ai.antigravity.customPathPlaceholder': 'например, /usr/local/bin/agy',
  'ai.antigravity.installGuide': 'Официальная инструкция',
  'ai.antigravity.check': 'Проверить',
  'ai.antigravity.resetPath': 'Сбросить',
  'ai.antigravity.upgradeRequired': 'Эта версия agy устарела. Обновите её до версии 1.1.4 или новее.',
  'ai.antigravity.loginHint': 'Перед использованием в Netcatty запустите agy в терминале и войдите в Google. Netcatty проверит вход при отправке сообщения.',
  'ai.antigravity.confirmHint': 'В режиме Confirm встроенные локальные инструменты Agy остаются только для чтения. Инструменты Netcatty по-прежнему запрашивают отдельное подтверждение.',
  ...
  'ai.chat.permConfirmDesc': 'Запись Netcatty требует подтверждения; локальные инструменты Agy только для чтения',
  ...
  'ai.safety.permissionMode.description': 'Управляет доступом AI к терминалам Netcatty. В режиме Confirm инструменты Netcatty запрашивают подтверждение каждой записи, а встроенные локальные инструменты Agy остаются только для чтения. Другие внешние агенты могут использовать собственный порядок подтверждений.',
