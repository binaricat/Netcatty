...
export const ruAiMessages: Messages = {
  ...
  'ai.chat.toolTimedOut': 'Тайм-аут',
  'ai.chat.toolPolicyDenied': 'Заблокировано',
  'ai.chat.toolObserverDenied': 'Наблюдатель',
  'ai.chat.toolApproved': 'Одобрено',
  'ai.chat.toolApprovalHint': 'Нажмите Enter для одобрения, Escape для отклонения. Автоотклонение через {seconds} с.',
  ...
  'ai.chat.approvalTimeout': 'Время ожидания одобрения инструмента истекло через 110 секунд. Вы можете повторить попытку, отправив сообщение ещё раз.',
