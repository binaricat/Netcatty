...
export const ruAiMessages: Messages = {
  ...
  'ai.codebuddy.apiKey': 'API Key',
  'ai.codebuddy.apiKey.placeholder': 'Введите CODEBUDDY_API_KEY',
  'ai.codebuddy.apiKey.hint': 'Устанавливает CODEBUDDY_API_KEY — необходим для аутентификации, если ещё не задан в оболочке.',
  ...
  'ai.codebuddy.envVars.placeholder': 'CODEBUDDY_MODEL=...\nOTHER_VAR=...',
  'ai.codebuddy.envVars.hint': 'По одной записи KEY=VALUE на строку, передаются агенту CodeBuddy. Хранятся локально в открытом виде.',
