...
export const ruAiMessages: Messages = {
  ...
  'ai.opencode.question.title': 'OpenCode требуется ваш ответ',
  'ai.opencode.question.description': 'Ответьте на вопросы, чтобы продолжить текущую задачу.',
  'ai.opencode.question.other': 'Введите другой ответ',
  'ai.opencode.question.skip': 'Пропустить',
  'ai.opencode.question.submit': 'Продолжить',
