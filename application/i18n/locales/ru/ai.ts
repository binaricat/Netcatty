...
export const ruAiMessages: Messages = {
  ...
  'ai.safety.maxIterations.description': 'Максимальное число шагов модельного цикла Catty за один ход.',
  'ai.safety.maxToolCalls': 'Макс. число вызовов инструментов',
  'ai.safety.maxToolCalls.description': 'Жёсткий лимит вызовов инструментов Netcatty за один ход. Также ограничивает внешних агентов на уровне MCP.',
  'ai.safety.maxTokens': 'Макс. число токенов',
  'ai.safety.maxTokens.description': 'Бюджет токенов Catty на один ход. 0 отключает лимит.',
  'ai.safety.maxCostUsd': 'Макс. стоимость (USD)',
  'ai.safety.maxCostUsd.description': 'Оценочный бюджет стоимости Catty на один ход. 0 отключает лимит.',
  'ai.safety.costPerMillionTokensUsd': 'USD за 1M токенов',
  'ai.safety.costPerMillionTokensUsd.description': 'Запасная оценка стоимости, если провайдер не сообщает цену. 0 означает использовать только стоимость от провайдера.',
