...
export const ruVaultMessages: Messages = {
  ...
  'hostDetails.distro.option.anolis': 'Anolis OS',
  'hostDetails.distro.option.openeuler': 'openEuler',
  'hostDetails.distro.option.kylin': 'Kylin',
  'hostDetails.distro.option.neokylin': 'NeoKylin',
  'hostDetails.distro.option.ubuntukylin': 'Ubuntu Kylin',
