...
export const ruVaultMessages: Messages = {
  ...
  'hostConnectionTest.title': 'Проверка подключения',
  'hostConnectionTest.test': 'Проверить',
  'hostConnectionTest.chainOf': 'Цепочка {current} из {total}',
  'hostConnectionTest.success': 'Подключение успешно',
  'hostConnectionTest.successHint': 'Хост принял ваши учётные данные. Можно закрыть окно.',
  'hostConnectionTest.connecting': 'Подключение… таймаут через {seconds} с',
  'hostConnectionTest.failed': 'Не удалось подключиться.',
  'hostConnectionTest.retry': 'Повторить',
  'hostConnectionTest.credentialsUnavailable': 'Сохранённые учётные данные не удаётся расшифровать на этом устройстве. Введите их заново ниже.',
