...
export const ruVaultMessages: Messages = {
  ...
  'hostDetails.singleChannelSsh': 'Одноканальный SSH (бастион)',
  'hostDetails.singleChannelSsh.desc': 'Не открывать дополнительные SFTP/exec-каналы на SSH-соединении терминала. Для бастионов, которые допускают только один канал сессии. Передача файлов идёт отдельным входом.',
  'hostDetails.singleChannelSsh.warning': 'Системная панель будет недоступна. Передача файлов использует отдельный вход и может быть ограничена политикой одновременных сессий.',
