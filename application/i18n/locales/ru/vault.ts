...
export const ruVaultMessages: Messages = {
  ...
  'hostDetails.icon.desc': 'Используйте автоматический значок дистрибутива или выберите встроенный значок и цвет.',
  'hostDetails.icon.mode.auto': 'Авто',
  'hostDetails.icon.mode.custom': 'Свой',
  'hostDetails.icon.reset': 'Сбросить значок',
  'hostDetails.icon.autoUsesDistro': 'Автоматический режим использует определенный или выбранный вручную значок дистрибутива Linux.',
  'hostDetails.icon.customOverridesDistro': 'Свой значок переопределяет значок дистрибутива Linux для этого хоста.',
