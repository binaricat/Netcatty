...
export const zhCNAiMessages: Messages = {
  ...
  'ai.antigravity.description': '使用 Google 官方 agy 命令，并复用你已有的 Google 登录。Netcatty 会自动识别，不会自行下载或内置它。',
  'ai.antigravity.detecting': '检测中...',
  'ai.antigravity.detected': '已检测到',
  'ai.antigravity.upgradeStatus': '需要升级',
  'ai.antigravity.notFound': '未找到',
  'ai.antigravity.path': 'agy：',
  'ai.antigravity.notFoundHint': '在 PATH 中没有找到 1.1.4 或更高版本的 agy。请从 Google 官方安装，或在下方指定它的路径。',
  'ai.antigravity.customPathPlaceholder': '例如 /usr/local/bin/agy',
  'ai.antigravity.installGuide': '查看官方安装说明',
  'ai.antigravity.check': '检查',
  'ai.antigravity.resetPath': '重置',
  'ai.antigravity.upgradeRequired': '当前 agy 版本过旧，请升级到 1.1.4 或更高版本。',
  'ai.antigravity.loginHint': '在 Netcatty 中使用前，请先在终端运行 agy 并完成 Google 登录。发送消息时，Netcatty 会实际验证登录是否可用。',
  'ai.antigravity.confirmHint': '在确认模式下，Agy 自带的本机工具保持只读；Netcatty 工具仍会逐项请求确认。',
  ...
  'ai.chat.permConfirmDesc': 'Netcatty 写操作逐项确认；Agy 本机工具保持只读',
  ...
  'ai.safety.permissionMode.description': '控制 AI 访问 Netcatty 终端会话的方式。确认模式下，Netcatty 工具的写操作会逐项询问；Agy 自带的本机工具保持只读。其他外部 Agent 可能有自己的审批方式。',
