...
export const zhCNAiMessages: Messages = {
  ...
  'ai.codebuddy.apiKey.placeholder': '输入 CODEBUDDY_API_KEY',
  'ai.codebuddy.apiKey.hint': '设置 CODEBUDDY_API_KEY —— 如果 shell 环境中尚未配置，则需要在此填写以完成鉴权。',
  ...
  'ai.codebuddy.envVars.hint': '每行一个 KEY=VALUE，传给 CodeBuddy agent。明文存在本地。',
