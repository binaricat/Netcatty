...
export const zhCNAiMessages: Messages = {
  ...
  'ai.opencode.question.title': 'OpenCode 需要你的输入',
  'ai.opencode.question.description': '回答以下问题以继续当前任务。',
  'ai.opencode.question.other': '输入其他答案',
  'ai.opencode.question.skip': '跳过',
  'ai.opencode.question.submit': '继续',
