...
export const zhCNAiMessages: Messages = {
  ...
  'ai.externalMcp.focusOnHostOpen': '打开主机时切换到前台',
  'ai.externalMcp.focusOnHostOpen.description': '开启后，外部 MCP 客户端通过 host_open 打开主机时，Netcatty 会自动显示并聚焦主窗口。关闭后主机仍会打开，但不会打断你当前的工作。',
