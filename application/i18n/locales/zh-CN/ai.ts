...
export const zhCNAiMessages: Messages = {
  ...
  'ai.chat.toolTimedOut': '已超时',
  'ai.chat.toolPolicyDenied': '已拦截',
  'ai.chat.toolObserverDenied': '观察者模式',
  'ai.chat.toolApproved': '已批准',
  'ai.chat.toolApprovalHint': '按回车批准，按 Esc 拒绝；{seconds} 秒后自动拒绝。',
  'ai.chat.approve': '批准',
  'ai.chat.reject': '拒绝',
  ...
  'ai.chat.approvalTimeout': '工具审批已超时（110 秒）。你可以重新发送消息来重试。',
