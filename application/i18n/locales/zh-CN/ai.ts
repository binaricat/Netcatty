...
export const zhCNAiMessages: Messages = {
  ...
  'ai.safety.maxIterations.description': 'Catty 单轮可执行的最大模型循环步数，达到后停止。',
  'ai.safety.maxToolCalls': '最大工具调用数',
  'ai.safety.maxToolCalls.description': '单轮经由 Netcatty 的工具调用硬上限；外部 Agent 也会在 MCP 工具层受此限制。',
  'ai.safety.maxTokens': '最大 Token 数',
  'ai.safety.maxTokens.description': 'Catty 单轮 token 预算。设为 0 表示关闭。',
  'ai.safety.maxCostUsd': '最大成本（USD）',
  'ai.safety.maxCostUsd.description': 'Catty 单轮估算成本预算。设为 0 表示关闭。',
  'ai.safety.costPerMillionTokensUsd': '每百万 Token 成本（USD）',
  'ai.safety.costPerMillionTokensUsd.description': '供应商未返回成本时用于估算的单价。设为 0 表示只使用供应商返回的成本。',
