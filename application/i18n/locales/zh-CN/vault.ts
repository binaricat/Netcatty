...
export const zhCNVaultMessages: Messages = {
  ...
  'hostDetails.icon.desc': '使用自动发行版图标，或选择内置图标和颜色。',
  'hostDetails.icon.mode.auto': '自动',
  'hostDetails.icon.mode.custom': '自定义',
  'hostDetails.icon.reset': '重置主机图标',
  'hostDetails.icon.autoUsesDistro': '自动模式使用探测到或手动选择的 Linux 发行版图标。',
  'hostDetails.icon.customOverridesDistro': '自定义图标会覆盖此主机的 Linux 发行版图标。',
