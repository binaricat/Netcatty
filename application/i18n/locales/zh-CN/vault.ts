...
export const zhCNVaultMessages: Messages = {
  ...
  'hostDetails.distro.option.anolis': '龙蜥 Anolis OS',
  'hostDetails.distro.option.openeuler': 'openEuler 欧拉',
  'hostDetails.distro.option.kylin': '银河麒麟',
  'hostDetails.distro.option.neokylin': '中标麒麟',
  'hostDetails.distro.option.ubuntukylin': '优麒麟',
