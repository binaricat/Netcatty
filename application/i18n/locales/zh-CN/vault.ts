...
export const zhCNVaultMessages: Messages = {
  ...
  'hostConnectionTest.title': '测试连接',
  'hostConnectionTest.test': '测试',
  'hostConnectionTest.chainOf': '第 {current}/{total} 跳',
  'hostConnectionTest.success': '连接成功',
  'hostConnectionTest.successHint': '主机已接受您的凭据。您可以关闭此窗口。',
  'hostConnectionTest.connecting': '正在连接… {seconds} 秒后超时',
  'hostConnectionTest.failed': '连接失败。',
  'hostConnectionTest.retry': '重试',
  'hostConnectionTest.credentialsUnavailable': '保存的凭据无法在此设备上解密。请在下方重新输入。',
  ...
  'terminal.progress.connected': '已连接',
