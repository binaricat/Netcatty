...
export const zhCNVaultMessages: Messages = {
  ...
  'hostDetails.singleChannelSsh': '单通道 SSH（堡垒机）',
  'hostDetails.singleChannelSsh.desc': '禁止在当前终端 SSH 上再开 SFTP/系统探测等通道。适用于行云管家、齐治等只允许一条会话通道的堡垒机。文件传输会改走独立连接。',
  'hostDetails.singleChannelSsh.warning': '开启后系统面板不可用。文件传输使用单独登录，可能受堡垒机并发会话限制。',
