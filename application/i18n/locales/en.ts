...
const en: Messages = {
  ...
  'hostDetails.chain.mode': 'Chain mode',
  'hostDetails.chain.mode.proxyTunnel': 'Proxy Tunnel',
  'hostDetails.chain.mode.relayShell': 'Relay Shell',
  'hostDetails.chain.mode.proxyTunnel.desc': 'Use SSH tunnel forwarding (ProxyJump style). Best compatibility for terminal, SFTP, and port forwarding.',
  'hostDetails.chain.mode.relayShell.desc': 'Login to the first relay host, then run ssh from relay to target. Use this when bastion blocks direct-tcpip forwarding.',
