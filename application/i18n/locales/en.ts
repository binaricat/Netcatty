...
const en: Messages = {
  ...
  'cloudSync.history.viewButton': 'History',
  'cloudSync.history.title': 'Vault Version History',
  'cloudSync.history.description': 'Browse and restore previous versions of your vault from the Gist revision history.',
  'cloudSync.history.empty': 'No revisions found.',
  'cloudSync.history.current': 'Current',
  'cloudSync.history.revision': 'Revision',
  'cloudSync.history.revisionPreview': 'Revision Contents',
  'cloudSync.history.device': 'Device',
  'cloudSync.history.hosts': 'Hosts',
  'cloudSync.history.keys': 'Keys',
  'cloudSync.history.snippets': 'Snippets',
  'cloudSync.history.identities': 'Identities',
  'cloudSync.history.restoreButton': 'Restore This Version',
  'cloudSync.history.restored': 'Vault restored from selected revision.',
  'cloudSync.history.revisionNotFound': 'Revision not found or does not contain vault data.',
  'cloudSync.history.decryptFailed': 'Cannot decrypt this revision. It may have been encrypted with a different master password.',
