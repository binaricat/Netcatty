...
export const enAiMessages: Messages = {
  ...
  'ai.safety.grants.description': 'Rules skip approval prompts in confirm mode. Use * for all sessions, host:prod-* for hostname patterns, and command globs like ls *.',
