...
export const enAiMessages: Messages = {
  ...
  'ai.chat.toolTimedOut': 'Timed out',
  'ai.chat.toolPolicyDenied': 'Blocked',
  'ai.chat.toolObserverDenied': 'Observer',
  'ai.chat.toolApproved': 'Approved',
  'ai.chat.toolApprovalHint': 'Press Enter to approve, Escape to reject. Auto-denies after {seconds}s.',
  ...
  'ai.chat.approvalTimeout': 'Tool approval timed out after 110 seconds. You can retry by sending your message again.',
