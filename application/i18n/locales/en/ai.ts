...
export const enAiMessages: Messages = {
  ...
  'ai.antigravity.description': 'Uses the official agy CLI and its existing Google sign-in. Netcatty detects it automatically and does not download or bundle it.',
  'ai.antigravity.detecting': 'Detecting...',
  'ai.antigravity.detected': 'Detected',
  'ai.antigravity.upgradeStatus': 'Upgrade required',
  'ai.antigravity.notFound': 'Not found',
  'ai.antigravity.path': 'agy:',
  'ai.antigravity.notFoundHint': 'Could not find agy 1.1.4 or later in PATH. Install it from Google or specify the executable path below.',
  'ai.antigravity.customPathPlaceholder': 'e.g. /usr/local/bin/agy',
  'ai.antigravity.installGuide': 'Official install guide',
  'ai.antigravity.check': 'Check',
  'ai.antigravity.resetPath': 'Reset',
  'ai.antigravity.upgradeRequired': 'This agy version is too old. Upgrade to version 1.1.4 or later.',
  'ai.antigravity.loginHint': 'Before using it in Netcatty, run agy in a terminal and complete Google sign-in. Netcatty verifies the login when you send a message.',
  'ai.antigravity.confirmHint': 'In Confirm mode, Agy\'s own local tools stay read-only. Netcatty tools still ask for approval one by one.',
  ...
  'ai.chat.permConfirmDesc': 'Ask before Netcatty writes; Agy local tools stay read-only',
  ...
  'ai.safety.permissionMode.description': 'Controls how the AI interacts with your Netcatty terminal sessions. In Confirm mode, Netcatty tools ask before each write; Agy\'s own local tools remain read-only. Other external CLIs may use their own approval flow.',
