...
export const enAiMessages: Messages = {
  ...
  'ai.safety.maxIterations.description': 'Maximum Catty model loop steps before the turn stops.',
  'ai.safety.maxToolCalls': 'Max Tool Calls',
  'ai.safety.maxToolCalls.description': 'Hard cap for Netcatty tool calls per turn. Also limits external agents at the MCP tool layer.',
  'ai.safety.maxTokens': 'Max Tokens',
  'ai.safety.maxTokens.description': 'Per-turn Catty token budget. Set 0 to disable.',
  'ai.safety.maxCostUsd': 'Max Cost (USD)',
  'ai.safety.maxCostUsd.description': 'Per-turn estimated Catty cost budget. Set 0 to disable.',
  'ai.safety.costPerMillionTokensUsd': 'USD per 1M Tokens',
  'ai.safety.costPerMillionTokensUsd.description': 'Fallback cost estimate when the provider does not report cost. Set 0 to use provider-reported cost only.',
