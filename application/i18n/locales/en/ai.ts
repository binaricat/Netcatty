...
export const enAiMessages: Messages = {
  ...
  'ai.opencode.question.title': 'OpenCode needs your input',
  'ai.opencode.question.description': 'Answer these questions to continue the current turn.',
  'ai.opencode.question.other': 'Enter another answer',
  'ai.opencode.question.skip': 'Skip',
  'ai.opencode.question.submit': 'Continue',
