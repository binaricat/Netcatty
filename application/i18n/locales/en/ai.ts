...
export const enAiMessages: Messages = {
  ...
  'ai.codebuddy.apiKey.placeholder': 'Enter CODEBUDDY_API_KEY',
  'ai.codebuddy.apiKey.hint': 'Sets CODEBUDDY_API_KEY — required for authentication if not already in your shell environment.',
  ...
  'ai.codebuddy.envVars.hint': 'One KEY=VALUE per line, passed to the CodeBuddy agent. Stored locally in plaintext.',
