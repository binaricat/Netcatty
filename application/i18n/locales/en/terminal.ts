...
export const enTerminalMessages: Messages = {
  ...
  'cloudSync.strategy.preferCloudHint': 'Cloud data will replace local changes when both sides changed.',
  'cloudSync.strategy.preferLocalHint': 'Local data will replace cloud changes when both sides changed.',
