...
export const enVaultMessages: Messages = {
  ...
  'hostDetails.icon.desc': 'Use automatic distro icons or choose a built-in icon and color.',
  'hostDetails.icon.mode.auto': 'Automatic',
  'hostDetails.icon.mode.custom': 'Custom',
  'hostDetails.icon.reset': 'Reset host icon',
  'hostDetails.icon.autoUsesDistro': 'Automatic uses the detected or manually selected Linux Distribution icon.',
  'hostDetails.icon.customOverridesDistro': 'Custom icon overrides Linux Distribution for this host.',
