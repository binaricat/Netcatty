...
export const enVaultMessages: Messages = {
  ...
  'hostConnectionTest.title': 'Test Connection',
  'hostConnectionTest.test': 'Test',
  'hostConnectionTest.chainOf': 'Chain {current} of {total}',
  'hostConnectionTest.success': 'Connection successful',
  'hostConnectionTest.successHint': 'The host accepted your credentials. You can close this window.',
  'hostConnectionTest.connecting': 'Connecting… timeout in {seconds}s',
  'hostConnectionTest.failed': 'Connection failed.',
  'hostConnectionTest.retry': 'Retry',
  'hostConnectionTest.credentialsUnavailable': 'Saved credentials cannot be decrypted on this device. Re-enter them below.',
