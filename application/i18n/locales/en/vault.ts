...
export const enVaultMessages: Messages = {
  ...
  'hostDetails.singleChannelSsh': 'Single-channel SSH (bastion)',
  'hostDetails.singleChannelSsh.desc': 'Do not open extra SFTP or exec channels on the terminal SSH connection. Use for bastions that allow only one session channel. File transfer uses a separate login.',
  'hostDetails.singleChannelSsh.warning': 'System Manager is unavailable while this is on. File transfer uses a second login and may be limited by concurrent-session policy.',
