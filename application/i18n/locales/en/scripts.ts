export const enScriptsMessages = {
  ...
  'scripts.trigger.onOutputHint': 'Fires when output matches the pattern. Suppressed while another script is running on this session; rechecked after it finishes. For in-flow waits, use nct.screen.waitFor in script code.',
