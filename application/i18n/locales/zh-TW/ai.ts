...
export const zhTWAiMessages: Messages = {
  ...
  'ai.opencode.question.title': 'OpenCode 需要你的輸入',
  'ai.opencode.question.description': '回答以下問題以繼續目前任務。',
  'ai.opencode.question.other': '輸入其他答案',
  'ai.opencode.question.skip': '略過',
  'ai.opencode.question.submit': '繼續',
