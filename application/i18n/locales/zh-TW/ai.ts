...
export const zhTWAiMessages: Messages = {
  ...
  'ai.antigravity.description': '使用 Google 官方 agy 指令，並沿用你現有的 Google 登入。Netcatty 會自動偵測，不會自行下載或內建它。',
  'ai.antigravity.detecting': '偵測中...',
  'ai.antigravity.detected': '已偵測到',
  'ai.antigravity.upgradeStatus': '需要升級',
  'ai.antigravity.notFound': '未找到',
  'ai.antigravity.path': 'agy：',
  'ai.antigravity.notFoundHint': '在 PATH 中找不到 1.1.4 或更新版本的 agy。請從 Google 官方安裝，或在下方指定它的路徑。',
  'ai.antigravity.customPathPlaceholder': '例如 /usr/local/bin/agy',
  'ai.antigravity.installGuide': '查看官方安裝說明',
  'ai.antigravity.check': '檢查',
  'ai.antigravity.resetPath': '重置',
  'ai.antigravity.upgradeRequired': '目前 agy 版本過舊，請升級到 1.1.4 或更新版本。',
  'ai.antigravity.loginHint': '在 Netcatty 中使用前，請先在終端執行 agy 並完成 Google 登入。傳送訊息時，Netcatty 會實際驗證登入是否可用。',
  'ai.antigravity.confirmHint': '在確認模式下，Agy 內建的本機工具保持唯讀；Netcatty 工具仍會逐項要求確認。',
  ...
  'ai.chat.permConfirmDesc': 'Netcatty 寫入逐項確認；Agy 本機工具保持唯讀',
  ...
  'ai.safety.permissionMode.description': '控制 AI 存取 Netcatty 終端工作階段的方式。確認模式下，Netcatty 工具的寫入會逐項詢問；Agy 內建的本機工具保持唯讀。其他外部 Agent 可能有自己的審批方式。',
