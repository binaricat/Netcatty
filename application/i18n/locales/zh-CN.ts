...
const zhCN: Messages = {
  ...
  'hostDetails.chain.mode': '链路模式',
  'hostDetails.chain.mode.proxyTunnel': '代理隧道',
  'hostDetails.chain.mode.relayShell': '中继 Shell',
  'hostDetails.chain.mode.proxyTunnel.desc': '使用 SSH 隧道转发（类似 ProxyJump），兼容终端、SFTP 与端口转发。',
  'hostDetails.chain.mode.relayShell.desc': '先登录第一台中继机，再由中继机 ssh 到目标机。适用于堡垒机禁用 direct-tcpip 转发的场景。',
