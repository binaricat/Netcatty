...
const zhCN: Messages = {
  ...
  'cloudSync.history.viewButton': '历史版本',
  'cloudSync.history.title': '主机库版本历史',
  'cloudSync.history.description': '浏览并恢复 Gist 修订历史中的旧版主机库数据。',
  'cloudSync.history.empty': '未找到修订记录。',
  'cloudSync.history.current': '当前版本',
  'cloudSync.history.revision': '修订',
  'cloudSync.history.revisionPreview': '修订内容',
  'cloudSync.history.device': '设备',
  'cloudSync.history.hosts': '主机',
  'cloudSync.history.keys': '密钥',
  'cloudSync.history.snippets': '代码片段',
  'cloudSync.history.identities': '身份',
  'cloudSync.history.restoreButton': '恢复此版本',
  'cloudSync.history.restored': '已从选中的修订恢复主机库数据。',
  'cloudSync.history.revisionNotFound': '修订未找到或不包含主机库数据。',
  'cloudSync.history.decryptFailed': '无法解密此修订。可能是使用了不同的主密钥加密的。',
