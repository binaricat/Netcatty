...
export const STORAGE_KEY_AI_MAX_TOOL_CALLS = 'netcatty_ai_max_tool_calls_v1';
export const STORAGE_KEY_AI_MAX_TOKENS = 'netcatty_ai_max_tokens_v1';
export const STORAGE_KEY_AI_MAX_COST_USD = 'netcatty_ai_max_cost_usd_v1';
export const STORAGE_KEY_AI_COST_PER_MILLION_TOKENS_USD = 'netcatty_ai_cost_per_million_tokens_usd_v1';
