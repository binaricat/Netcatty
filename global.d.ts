...
declare global {
  ...
  interface NetcattyBridge {
    ...
    aiAcpStream?(requestId: string, chatSessionId: string, acpCommand: string, acpArgs: string[], prompt: string, cwd?: string, providerId?: string, model?: string, images?: Array<{ base64Data: string; mediaType: string; filename?: string }>, history?: Array<{ role: string; content: unknown }>): Promise<{ ok: boolean; error?: string }>;
