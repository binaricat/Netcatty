...
declare global {
  ...
  interface NetcattyBridge {
    ...
    aiAcpStream?(requestId: string, chatSessionId: string, acpCommand: string, acpArgs: string[], messages: Array<Record<string, unknown>>, cwd?: string, providerId?: string, model?: string): Promise<{ ok: boolean; error?: string }>;
